...
- Deploy an **ingress** gateway for the sentences application
...
#### Task: Modify `sentences-ingress-gw.yaml` and `sentences-ingress-vs.yaml`
...
#### Task: Deploy sentences application in `004-egress-traffic/start`
